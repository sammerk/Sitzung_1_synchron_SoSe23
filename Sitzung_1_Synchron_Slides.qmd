...
## Mini-Survey 1 {.center}
> Bitte bearbeiten Sie die Mini-Survey 1 (link auf moodle unter bit.ly/merk089)
...
* **Erklärvideos** und **Aufgaben** werden spätestens donnerstags in moodle [https://bit.ly/merk](https://bit.ly/merk) bereitgestellt und können zu einem beliebigen Zeitpunkt rezipiert/bearbeitet werden.
* Tutorium (quantitativ - Merk)
...
> Link »Eingangsbefragung« auf {{< ai moodle >}}oodle (https://bit.ly/)
...
## <!-- Image -->{background-image="img/formative_ass_klausur.png" background-size="contain"}
